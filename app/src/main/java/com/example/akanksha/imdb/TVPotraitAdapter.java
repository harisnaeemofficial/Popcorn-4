...
public class TVPotraitAdapter extends RecyclerView.Adapter<MoviePortraitHolder>{
    ...
    @Override
    public void onBindViewHolder(@NonNull final  MoviePortraitHolder holder, int position) {
        ...
        String url = "https://image.tmdb.org/t/p/w500/" + shows.getBackdrop_path();
